...
class Embed {
  ...
  addField(name: any, value: any, inline: any) {
  ...
  setThumbnail(url: any, width: any, height: any) {
    this.obj.thumbnail = {
      url: url,
      width: width || null,
      height: height || null
  ...
  setImage(url: any, height: any, width: any) {
    this.obj.image = {
      url: url,
      width: width || null,
      height: height || null
  ...
  setAuthor(name: any, icon: any, url: any) {
    this.obj.author = {
      name: name,
      icon_url: icon,
      url: url
  ...
  setTimestamp(timestamp: any = new Date()) {
